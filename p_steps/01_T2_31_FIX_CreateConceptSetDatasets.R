...
concept_sets_of_our_study_to_be_fixed = c("DP_VACCINES", "O_DEATHSUDDEN_AESI_narrow", "O_DEATHSUDDEN_AESI_possible")
print('RETRIEVE FROM CDM RECORDS CORRESPONDING TO CONCEPT SETS')

CreateConceptSetDatasets(concept_set_names = concept_sets_of_our_study_to_be_fixed,
