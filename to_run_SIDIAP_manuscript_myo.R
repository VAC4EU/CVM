...
# Implemented support for SIDIAP (covid tests included in the covid definition)
...
# system.time(source(paste0(thisdir,"/p_step s/step_07_1_T3_create_person_time_risks.R")))
